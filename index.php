    ...
    <div class="container-fluid p-0 wow fadeIn" data-wow-delay="0.1s">
        <div id="header-carousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
               <?php
               $query=mysqli_query($conn,"select * from tbl_slider where is_active=1 order by
                                          slider_id asc");
               $id=1;
               ...
               ?>
                ...
                <div class="carousel-item <?=($id==1 ? 'active' : '')?>">
                    <img class="w-100" src="<?=BASE_URL_IMG?>slider/<?=$row['slider_img']?>">
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    <h1 class="display-1 text-white mb-5 animated slideInDown"><?=$row['slider_heading']?></h1>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            ...
            <div class="row wow fadeInUp" data-wow-delay="0.3s">
                <div class="col-12 text-center">
                    <ul class="list-inline rounded mb-5" id="portfolio-flters">
                        ...
                        {
                        ?>
                        <li class="mx-2" data-filter=".id_<?=$row['prj_cat_id']?>"><?=$row['prj_cat_name']?></li>
                        <?php }?>
            ...
            <div class="row g-4 portfolio-container">
                <?php
                        $query=mysqli_query($conn,"select * from tbl_prj_img where is_active=1");
                        while($row=mysqli_fetch_array($query))
                        {
                        ?>
